...
#define H 0.1 // Шаг
#define A 1.6 // Начальное значение x
#define B 2.6 // Конечное значение x (изменено на 3.1)
...
int main() {
    double x0 = A;
    double y_values[STEPS + 10] = {4.6, 4.65, 4.7, 4.75}; // Массив начальных значений y
